...
<div id="ag-gate" style="max-width:500px;margin:2em auto;padding:2em;text-align:center;border:1px solid #ddd;border-radius:12px;background:#f9f9f9;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
  <h3 style="margin-top:0;font-size:1.4em;">Restricted Content</h3>
  <p style="color:#666;margin-bottom:1.5em;">The remaining sections of this guide are password-protected. Enter the password to continue.</p>
  <input type="password" id="ag-pw" placeholder="Enter password" style="padding:0.6em 1em;font-size:1.05em;border:1px solid #ccc;border-radius:6px;width:280px;box-sizing:border-box;" />
  <br/><br/>
  <button id="ag-btn" onclick="agUnlock()" style="padding:0.6em 2.5em;font-size:1.05em;cursor:pointer;border:none;border-radius:6px;background:#1e40af;color:white;">Unlock</button>
  <p id="ag-err" style="color:#c0392b;margin-top:1em;display:none;font-size:0.9em;">Incorrect password. Please try again.</p>
</div>

<div id="ag-protected" style="display:none;" markdown="1">
...
function agUnlock() {
  ...
  if (pw === 'ai2026') {
    document.getElementById('ag-protected').style.display = 'block';
    document.getElementById('ag-gate').style.display = 'none';
  } else {
    document.getElementById('ag-err').style.display = 'block';
