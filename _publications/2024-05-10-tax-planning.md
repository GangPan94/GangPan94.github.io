...
The identification strategy combines cross-sectional regressions of excess returns (Alpha) on decreases in cash effective tax rates (DCETR) with firm and year fixed effects, plus two causal tests that exploit the Tax Cuts and Jobs Act of 2017: (1) an event study of market reactions to TCJA legislation events, and (2) a difference-in-differences design examining whether the excess-return-to-tax-planning relation erodes after 2017 for firms most exposed to cross-border relocation.
