...
excerpt: 'Does corporate tax planning create a substantial competitive advantage? I find the advantage exists but is modest — tax planning explains only 0.5% of variation in excess returns, far less than sales growth (9.3%). The advantage does not persist; cash ETRs converge in the long run.'
identification: >
