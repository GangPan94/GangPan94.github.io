...
myth_busters:
  ...
  - myth: "Tax planning is a relatively substitutional source of competitive advantage."
    reality: "Other business strategies explain far more of the variation in excess returns. In horserace regressions, tax planning has the smallest factor loading among compared strategies — sales growth and COGS reductions each account for over seven times the variance, and even interest-expense reductions outperform it."
    implication: "The paper documents that tax planning is not an irreplaceable source of competitive advantage. Pretax performance enhancements play a substantially larger role in generating excess returns, and the evidence highlights that tax planning's relative contribution is modest compared to other business strategies. Tax planning remains an essential part of corporate strategy, but it is not a unique driver of competitive advantage."
