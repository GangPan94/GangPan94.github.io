...
myth_busters:
  ...
  - myth: "Tax planning is a relatively substitutional source of competitive advantage."
    reality: "Other business strategies explain far more of the variation in excess returns, and tax planning has the smallest factor loading among compared strategies."
    implication: "The paper documents that tax planning innovations have less explanatory power for excess returns than pretax performance enhancements. Tax planning remains an essential part of corporate strategy, but on average it is not a significant source of competitive advantage."
